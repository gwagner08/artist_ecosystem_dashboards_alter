...
Sprout is scoped to a single group (Mick Management), and everything is grouped **by
...
2. **Run the verifier.**
   ...
   - your Sprout customer IDs and every group ID + name, so you can find Mick Management's
